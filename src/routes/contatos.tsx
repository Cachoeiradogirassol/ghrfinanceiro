      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-2">
            <Users className="h-6 w-6 text-primary" /> Fornecedores e Colaboradores
          </h1>
            ...
            <TableBody>
              {(contacts.data ?? []).map((contact) => (
                <TableRow key={contact.id}>
                  ...
                  <TableCell>
                    {contact.type === "COLABORADOR" ? "Colaborador" : "Fornecedor"}
                  </TableCell>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setForm({ ...form, document_type: value as FormState["document_type"] })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                <Label>{form.document_type === "PF" ? "CPF" : "CNPJ"} (opcional)</Label>
                <Input
